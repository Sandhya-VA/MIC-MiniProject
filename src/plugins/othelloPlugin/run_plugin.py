"""
This script is called by the plugin-wrapper, othelloPlugin.js, which passes down the
...
from othelloPlugin import othelloPlugin
...
plugin = othelloPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
