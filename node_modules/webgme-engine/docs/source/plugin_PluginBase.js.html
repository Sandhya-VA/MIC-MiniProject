...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: plugin/PluginBase.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: plugin/PluginBase.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/*globals define, requirejs*/
