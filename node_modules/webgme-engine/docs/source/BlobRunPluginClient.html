...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: BlobRunPluginClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: BlobRunPluginClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>BlobRunPluginClient<span class="signature">(parameters)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="BlobRunPluginClient"><span class="type-signature"></span>new BlobRunPluginClient<span class="signature">(parameters)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Initializes a new instance of a server side file system object.</p>
<p>Note: This code strictly runs in node.js (server side).</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="server_middleware_blob_BlobRunPluginClient.js.html">server/middleware/blob/BlobRunPluginClient.js</a>, <a href="server_middleware_blob_BlobRunPluginClient.js.html#line29">line 29</a>
    </li></ul></dd>
