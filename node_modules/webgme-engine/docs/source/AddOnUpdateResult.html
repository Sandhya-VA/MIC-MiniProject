...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AddOnUpdateResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AddOnUpdateResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AddOnUpdateResult<span class="signature">(commitObj)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="AddOnUpdateResult"><span class="type-signature"></span>new AddOnUpdateResult<span class="signature">(commitObj)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Represents the report format add-ons resolves with after an update.
There is no need for the add-on to report if it made changes or not,
the monitor/manager will always persist and if there are no changed objects</p>
<ul>
<li>it won't commit to the storage.</li>
</ul>
</div>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>commitObj</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="addon_AddOnUpdateResult.js.html">addon/AddOnUpdateResult.js</a>, <a href="addon_AddOnUpdateResult.js.html#line20">line 20</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addCommitMessage"><span class="type-signature"></span>addCommitMessage<span class="signature">(addOn, msg)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Create or appends to the commit message.</p>
</div>
...
<span class="param-type"><a href="AddOnBase.html">AddOnBase</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="addon_AddOnUpdateResult.js.html">addon/AddOnUpdateResult.js</a>, <a href="addon_AddOnUpdateResult.js.html#line32">line 32</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addNotification"><span class="type-signature"></span>addNotification<span class="signature">(addOn, notification)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Notification</span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="addon_AddOnUpdateResult.js.html">addon/AddOnUpdateResult.js</a>, <a href="addon_AddOnUpdateResult.js.html#line45">line 45</a>
    </li></ul></dd>
