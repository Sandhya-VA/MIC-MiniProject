...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: Server:SafeStorage</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: Server:SafeStorage</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>This class forwards function calls to the storage and in addition:</p>
<ul>
<li>checks that input data is of correct format.</li>
<li>checks that users are authorized to access/change projects.</li>
<li>updates _users and _projects collections on delete/createProject.</li>
</ul></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="server_storage_safestorage.js.html">server/storage/safestorage.js</a>, <a href="server_storage_safestorage.js.html#line3">line 3</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="Server_SafeStorage-SafeStorage.html">SafeStorage</a></dt>
            <dd></dd>
        </dl>
