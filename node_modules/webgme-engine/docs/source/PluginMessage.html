...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PluginMessage</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PluginMessage</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>PluginMessage<span class="signature">(config)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="PluginMessage"><span class="type-signature"></span>new PluginMessage<span class="signature">(config)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Initializes a new instance of plugin message.</p>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginMessage.js.html">plugin/PluginMessage.js</a>, <a href="plugin_PluginMessage.js.html#line29">line 29</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="serialize"><span class="type-signature"></span>serialize<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#object">object</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginMessage.js.html">plugin/PluginMessage.js</a>, <a href="plugin_PluginMessage.js.html#line57">line 57</a>
    </li></ul></dd>
