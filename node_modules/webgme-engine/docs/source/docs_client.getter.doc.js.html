...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: docs/client.getter.doc.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: docs/client.getter.doc.js</h1>
...
// expect(typeof node.isReadOnly).to.equal('function');</code></pre>
        </article>
    </section>
