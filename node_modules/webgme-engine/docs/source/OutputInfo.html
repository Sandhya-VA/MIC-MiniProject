...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: OutputInfo</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: OutputInfo</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>OutputInfo<span class="signature">(jobHash, params)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="OutputInfo"><span class="type-signature"></span>new OutputInfo<span class="signature">(jobHash, params)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Class describing an output from an execution. The data is used for communication between the
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>jobHash</code></td>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Identifier for the job.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The output string.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>outputNumber</code></td>
...
<span class="param-type"><a href="global.html#number">number</a></span>
            ...
            <td class="description last"><p>Ordered id of output (0, 1, 2..)</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_executor_OutputInfo.js.html">common/executor/OutputInfo.js</a>, <a href="common_executor_OutputInfo.js.html#line20">line 20</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_executor_OutputInfo.js.html">common/executor/OutputInfo.js</a>, <a href="common_executor_OutputInfo.js.html#line25">line 25</a>
    </li></ul></dd>
...
<h4 class="name" id="output"><span class="type-signature"></span>output<span class="type-signature"> :<a href="global.html#string">string</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_executor_OutputInfo.js.html">common/executor/OutputInfo.js</a>, <a href="common_executor_OutputInfo.js.html#line37">line 37</a>
    </li></ul></dd>
...
<div class="description">
    <p>Ordered id of output (0, 1, 2..)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_executor_OutputInfo.js.html">common/executor/OutputInfo.js</a>, <a href="common_executor_OutputInfo.js.html#line31">line 31</a>
    </li></ul></dd>
