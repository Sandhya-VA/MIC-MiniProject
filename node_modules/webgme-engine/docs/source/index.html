...
<div id="main">
    ...
    <section>
        <article><p><a href="https://opensource.org/licenses/MIT"><img src="https://img.shields.io/github/license/mashape/apistatus.svg?maxAge=2592000" alt="license"></a>
<a href="https://travis-ci.org/webgme/webgme"><img src="https://travis-ci.org/webgme/webgme.svg?branch=master" alt="Build Status"></a>
<a href="https://www.npmjs.com/package/webgme"><img src="https://badge.fury.io/js/webgme.svg" alt="Version"></a>
<a href="http://img.shields.io/npm/dm/webgme.svg?style=flat"><img src="http://img.shields.io/npm/dm/webgme.svg?style=flat" alt="Downloads"></a></p>
<h1>Developer documentation</h1>
<p>The following pages are intended for WebGME
users that intend to extend the basic WebGME
framework with plugins or user-defined UI pieces.</p>
<ul>
<li><a href="Core.html">Core</a> - The most important API that holds the key for
basic model manipulation and interpretation.</li>
<li><a href="Client.html">Client</a> - The main entrypoint for UI extensions. This is the API
that developers use for communication with the core on the client side in the UI.</li>
</ul></article>
    </section>
