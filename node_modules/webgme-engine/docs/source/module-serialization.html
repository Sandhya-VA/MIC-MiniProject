...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: serialization</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: serialization</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Functions for serializing a webgme project or models. These will work both on the client and server. <br>
...
before attempting to export.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_util_serialization.js.html">common/util/serialization.js</a>, <a href="common_util_serialization.js.html#line15">line 15</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".exportModelsToFile"><span class="type-signature">(static) </span>exportModelsToFile<span class="signature">(project, blobClient, parameters, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Exports a selection of models and packages them in webgmexm file which is uploaded to the blob storage.</p>
</div>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>One of rootHash, commitHash and branchName and tagName must be given.
If more than one is given, the order of precedence is: branchName, commitHash, tagName and rootHash.</p>
                <h6>Properties</h6>
...
<span class="param-type"><a href="global.html#Array">Array</a>.&lt;<a href="global.html#string">string</a>></span>
            ...
            <td class="description last"><p>Paths to node to export.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The hash of the tree root.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The tree associated with the commitHash.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The tree at the given branch.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The tree at the given tag.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>withAssets</code></td>
...
<span class="param-type"><a href="global.html#boolean">boolean</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>outName</code></td>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Name of the output blob (.webgmex will be appended).</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#null">null</a></span>
            ...
            <td class="description last"><p>If there was an error</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>Data about the exported project</p>
                <h6>Properties</h6>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Metadata hash to the exported webgmexm-file</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Download url of the exported webgmexm-file</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The name of the exported webgmexm-file</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_util_serialization.js.html">common/util/serialization.js</a>, <a href="common_util_serialization.js.html#line101">line 101</a>
    </li></ul></dd>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id=".exportProjectToFile"><span class="type-signature">(static) </span>exportProjectToFile<span class="signature">(project, blobClient, parameters, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Exports a snap-shot of the entire project-tree and uploads a webgmex-file on the blob storage.</p>
</div>
...
<span class="param-type"><a href="global.html#boolean">boolean</a></span>
            ...
            <td class="description last"><p>Bundle the encountered assets linked from attributes.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>If not given will use the one defined in project (if any).</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Metadata hash to the exported webgmex-file</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Download url of the exported webgmex-file</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>The name of the exported webgmex-file</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="common_util_serialization.js.html">common/util/serialization.js</a>, <a href="common_util_serialization.js.html#line47">line 47</a>
    </li></ul></dd>
