...
<dl class="details">
    ...
    <h4 class="name" id="addArtifact"><span class="type-signature"></span>addArtifact<span class="signature">(name, files, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="addFile"><span class="type-signature"></span>addFile<span class="signature">(name, data, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="baseIsMeta"><span class="type-signature"></span>baseIsMeta<span class="signature">(node)</span><span class="type-signature"> &rarr; {<a href="global.html#boolean">boolean</a>}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="fastForward"><span class="type-signature"></span>fastForward<span class="signature">(callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="getArtifact"><span class="type-signature"></span>getArtifact<span class="signature">(metadataHash)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="getBinFile"><span class="type-signature"></span>getBinFile<span class="signature">(metadataHash, subpath<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="getConfigStructure"><span class="type-signature"></span>getConfigStructure<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#Array">Array</a>.&lt;<a href="global.html#object">object</a>>}</span></h4>
...
<span class="param-type"><a href="global.html#Array">Array</a>.&lt;<a href="global.html#object">object</a>></span>
    ...
    <h4 class="name" id="getCurrentConfig"><span class="type-signature"></span>getCurrentConfig<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="PluginConfig.html">PluginConfig</a>}</span></h4>
...
<span class="param-type"><a href="PluginConfig.html">PluginConfig</a></span>
    ...
    <h4 class="name" id="getDefaultConfig"><span class="type-signature"></span>getDefaultConfig<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="PluginConfig.html">PluginConfig</a>}</span></h4>
...
<span class="param-type"><a href="PluginConfig.html">PluginConfig</a></span>
    ...
    <h4 class="name" id="getDescription"><span class="type-signature"></span>getDescription<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#string">string</a>}</span></h4>
...
<span class="param-type"><a href="global.html#string">string</a></span>
    ...
    <h4 class="name" id="getFile"><span class="type-signature"></span>getFile<span class="signature">(metadataHash)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<span class="param-type"><a href="global.html#string">string</a></span>
    ...
    <h4 class="name" id="getMetaType"><span class="type-signature"></span>getMetaType<span class="signature">(node)</span><span class="type-signature"> &rarr; {<a href="module-Core.html#~Node">module:Core~Node</a>}</span></h4>
...
<span class="param-type"><a href="module-Core.html#~Node">module:Core~Node</a></span>
    ...
    <h4 class="name" id="getMetadata"><span class="type-signature"></span>getMetadata<span class="signature">()</span><span class="type-signature"> &rarr; {PluginMetaData}</span></h4>
...
<span class="param-type">PluginMetaData</span>
    ...
    <h4 class="name" id="getName"><span class="type-signature"></span>getName<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#string">string</a>}</span></h4>
...
<span class="param-type"><a href="global.html#string">string</a></span>
    ...
    <h4 class="name" id="getPluginDependencies"><span class="type-signature"></span>getPluginDependencies<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#Array">Array</a>.&lt;<a href="global.html#string">string</a>>}</span></h4>
...
<div class="description">
    <p>Retrieves the identity of the current user of the opened project (the user who invoked the plugin).</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line676">line 676</a>
    </li></ul></dd>
...
<span class="param-type"><a href="global.html#string">string</a></span>
    ...
    <h4 class="name" id="getVersion"><span class="type-signature"></span>getVersion<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="global.html#string">string</a>}</span></h4>
...
<div class="description">
    <p>Current version of this plugin using semantic versioning.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line205">line 205</a>
    </li></ul></dd>
...
<span class="param-type"><a href="global.html#string">string</a></span>
    ...
    <h4 class="name" id="initialize"><span class="type-signature"></span>initialize<span class="signature">(logger, blobClient, gmeConfig)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Initializes the plugin with objects that can be reused within the same plugin instance.</p>
</div>
...
<span class="param-type"><a href="GmeLogger.html">GmeLogger</a></span>
            ...
            <td class="description last"><p>logging capability to console (or file) based on PluginManager configuration</p></td>
        </tr>
...
<span class="param-type"><a href="BlobClient.html">BlobClient</a></span>
            ...
            <td class="description last"><p>virtual file system where files can be generated then saved as a zip file.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#GmeConfig">GmeConfig</a></span>
            ...
            <td class="description last"><p>global configuration for webGME.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line912">line 912</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="invokePlugin"><span class="type-signature"></span>invokePlugin<span class="signature">(pluginId, context<span class="signature-attributes">opt</span>, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<div class="description">
    <p>Initializes and invokes the given plugin (at pluginId).
Things to note:</p>
<ol>
<li>If the invoked plugin calls save - it will not persist nor make a commit. The message will be recorded in
the InterPluginResult.</li>
<li>Artifacts and files saved will be added to the blob-storage. Invoked plugins can expose the content by adding
it to itself - the instance will be available in the InterPluginResult.</li>
</ol>
</div>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Id of plugin that should be invoked</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>Optional context for the invoked plugin</p>
                <h6>Properties</h6>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>Namespace (relative this.namespace)</p></td>
        </tr>
...
<span class="param-type"><a href="module-Core.html#~Node">module:Core~Node</a></span>
            ...
            <td class="description last"><p>Active node of invoked plugin</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#Array">Array</a>.&lt;<a href="module-Core.html#~Node">module:Core~Node</a>></span>
            ...
            <td class="description last"><p>Active selection
of invoked plugin</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>Specific configuration parameters that should be used for the
invocation.
If not provided will first check if the currentConfig of this plugin contains this plugin as dependency within
the array this._currentConfig._dependencies. Finally it will fall back to the default config of the plugin.</p></td>
        </tr>
...
<span class="param-type"><a href="InterPluginResult.html">InterPluginResult</a></span>
            ...
            <td class="description last"><p>result from the invoked plugin</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line703">line 703</a>
    </li></ul></dd>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="isInvalidActiveNode"><span class="type-signature"></span>isInvalidActiveNode<span class="signature">(pluginId)</span><span class="type-signature"> &rarr; {<a href="global.html#Error">Error</a>}</span></h4>
...
<div class="description">
    <p>Checks if the activeNode has registered the plugin.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line637">line 637</a>
    </li></ul></dd>
...
<div class="param-desc">
    <ul>
<li>returns undefined if valid and an Error if not.</li>
</ul>
</div>
...
<span class="param-type"><a href="global.html#Error">Error</a></span>
    ...
    <h4 class="name" id="isMetaTypeOf"><span class="type-signature"></span>isMetaTypeOf<span class="signature">(node, metaNode)</span><span class="type-signature"> &rarr; {<a href="global.html#boolean">boolean</a>}</span></h4>
...
<div class="description">
    <p>Checks if the given node is of the given meta-type.
Usage: <tt>self.isMetaTypeOf(aNode, self.META['FCO']);</tt></p>
</div>
...
<span class="param-type"><a href="module-Core.html#~Node">module:Core~Node</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>metaNode</code></td>
...
<span class="param-type"><a href="module-Core.html#~Node">module:Core~Node</a></span>
            ...
            <td class="description last"><p>Node object defining the meta type.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line308">line 308</a>
    </li></ul></dd>
...
<div class="param-desc">
    <ul>
<li>True if the given object was of the META type.</li>
</ul>
</div>
...
<span class="param-type"><a href="global.html#boolean">boolean</a></span>
    ...
    <h4 class="name" id="loadNodeMap"><span class="type-signature"></span>loadNodeMap<span class="signature">(node<span class="signature-attributes">opt</span>, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<div class="description">
    <p>Loads all the nodes in the subtree starting from node and returns a map from paths to nodes.</p>
</div>
...
<span class="param-type"><a href="module-Core.html#~Node">module:Core~Node</a></span>
            ...
            <td class="description last"><p>Optional node to preload nodes from,
by default all will be loaded.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>keys are paths and values are nodes</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line656">line 656</a>
    </li></ul></dd>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="main"><span class="type-signature"></span>main<span class="signature">(callback)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Main function for the plugin to execute. This will perform the execution.
Notes:
...
<br>- callback always have to be called even if error happened.</p>
</div>
...
<span class="param-type"><a href="PluginResult.html">PluginResult</a></span>
            ...
            <td class="description last"><p>plugin result</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line168">line 168</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="onAbort"><span class="type-signature"></span>onAbort<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Aborts the execution of a plugin.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line1032">line 1032</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="onMessage"><span class="type-signature"></span>onMessage<span class="signature">(messageType, content)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Can send a message to the plugin.</p>
</div>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>string identifier of the message.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>object that holds arbitrary content of the message.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line1041">line 1041</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="save"><span class="type-signature"></span>save<span class="signature">(message, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="external-Promise.html">external:Promise</a>}</span></h4>
...
<div class="description">
    <p>Saves all current changes if there is any to a new commit.
If the commit result is either 'FORKED' or 'CANCELED', it creates a new branch.</p>
<p>N.B. This is a utility function for saving/persisting data. The plugin has access to the project and core
instances and may persist and make the commit as define its own behavior for e.g. 'FORKED' commits.
To report the commits in the PluginResult make sure to invoke this.addCommitToResult with the given status.</p>
</div>
...
<span class="param-type"><a href="module-Storage.html#~CommitResult">module:Storage~CommitResult</a></span>
            ...
            <td class="description last"><p>status of the commit made</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line455">line 455</a>
    </li></ul></dd>
...
<span class="param-type"><a href="external-Promise.html">external:Promise</a></span>
    ...
    <h4 class="name" id="sendNotification"><span class="type-signature"></span>sendNotification<span class="signature">(message, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sends a notification back to the invoker of the plugin, can be used to notify about progress.</p>
</div>
...
<span class="param-type"><a href="global.html#object">object</a></span>
            ...
            <td class="description last"><p>Message string or object containing message.</p>
                <h6>Properties</h6>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>If object it must contain a message.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#number">number</a></span>
            ...
            <td class="description last"><p>Approximate progress (in %) of the plugin at time of sending.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#string">string</a></span>
            ...
            <td class="description last"><p>Severity level ('success', 'info', 'warn', 'error')</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>toBranch</code></td>
...
<span class="param-type"><a href="global.html#boolean">boolean</a></span>
            ...
            <td class="description last"><p>If true, and the plugin is running on the server on a branch -
will broadcast to all sockets in the branch room.</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#function">function</a></span>
            ...
            <td class="description last"><p>optional callback invoked when message has been emitted from server.</p>
                <h6>Properties</h6>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line395">line 395</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="setCurrentConfig"><span class="type-signature"></span>setCurrentConfig<span class="signature">(newConfig)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sets the current configuration of the plugin.</p>
</div>
...
<span class="param-type"><a href="PluginConfig.html">PluginConfig</a></span>
            ...
            <td class="description last"><p>this is the actual configuration and NOT the configuration structure.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line1000">line 1000</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="updateMETA"><span class="type-signature"></span>updateMETA<span class="signature">(generatedMETA)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>WebGME can export the META types as path and this method updates the generated domain specific types with
webgme node objects. These can be used to define the base class of new objects created through the webgme API.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>generatedMETA</code></td>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line289">line 289</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="updateSuccess"><span class="type-signature"></span>updateSuccess<span class="signature">(value, message)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Updates the current success flag with a new value.</p>
<p>NewValue = OldValue &amp;&amp; Value</p>
</div>
...
<span class="param-type"><a href="global.html#boolean">boolean</a></span>
            ...
            <td class="description last"><p>apply this flag on current success value</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#null">null</a></span>
            ...
            <td class="description last"><p>optional detailed message</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="plugin_PluginBase.js.html">plugin/PluginBase.js</a>, <a href="plugin_PluginBase.js.html#line270">line 270</a>
    </li></ul></dd>
